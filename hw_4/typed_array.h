...
public:
    ...
    TypedArray concat(TypedArray& other);
    TypedArray& reverse();
...
template <typename ElementType>
TypedArray<ElementType> TypedArray<ElementType>::concat(TypedArray<ElementType>& other) {
...
template <typename ElementType>
TypedArray<ElementType> TypedArray<ElementType>::operator+(TypedArray<ElementType>& other) {
